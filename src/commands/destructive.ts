...
export const DESTRUCTIVE_COMMANDS: ReadonlySet<CommandName> = new Set<CommandName>([
    ...
    Commands.CONVERT_TABS_TO_SPACES,
    Commands.CONVERT_SPACES_TO_TABS,
    Commands.INCREASE_INDENT,
    Commands.DECREASE_INDENT,
    Commands.TO_WINDOWS_EOL,
    Commands.TO_UNIX_EOL,
    Commands.TO_MAC_EOL,
    Commands.REMOVE_DUPLICATE_LINES,
    Commands.REMOVE_CONSECUTIVE_DUPLICATE_LINES,
    Commands.SORT_ASCENDING,
    Commands.SORT_DESCENDING,
    ...
    Commands.COMMENT_LINE,
    Commands.UNCOMMENT_LINE,
    Commands.COMMENT_BLOCK,
    Commands.UNCOMMENT_BLOCK,
    Commands.DUPLICATE_LINE,
    Commands.INSERT_LINE_BEFORE,
    Commands.INSERT_LINE_AFTER,
    Commands.MOVE_LINE_UP,
    Commands.MOVE_LINE_DOWN,
    Commands.DELETE_LINES_CONTAINING,
    Commands.KEEP_ONLY_LINES_CONTAINING,
    Commands.HIGHLIGHT_MATCHES,
